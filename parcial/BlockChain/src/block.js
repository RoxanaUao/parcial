...
class Block {
  constructor(data) {
    this.hash = null; // SE CALCULA CON LOS DATOS QUE TIENE EL BLOQUE ENCIMA
    this.height = 0; //
    this.body = Buffer.from(JSON.stringify(data).toString("hex"));
    this.time = 0; //EN QUE MOMENTO SE AÑADE A LA CADENA
    this.previousBlockHash = null;//al ser una lista enlazada necesta saber de donde proviene
  }
